...
type InitFunc func(ctx context.Context, registry distribution.Namespace, options map[string]any) (distribution.Namespace, error)
...
func Get(ctx context.Context, name string, options map[string]any, registry distribution.Namespace) (distribution.Namespace, error) {
	if middlewares != nil {
