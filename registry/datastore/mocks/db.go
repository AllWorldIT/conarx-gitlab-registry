...
// Source: github.com/docker/distribution/registry/datastore (interfaces: Handler,Transactor,LoadBalancer)
//
// Generated by this command:
//
//	mockgen -package mocks -destination mocks/db.go . Handler,Transactor,LoadBalancer
//
