...
// DriverOldSuite is a gocheck test suite designed to test a
// storagedriver.StorageDriver. The intended way to create a DriverOldSuite is
// with RegisterSuite.
type DriverOldSuite struct {
	Constructor DriverConstructor
...
func (suite *DriverOldSuite) SetUpSuite(c *check.C) {
...
func (suite *DriverOldSuite) TearDownSuite(c *check.C) {
...
// driver.
func (suite *DriverOldSuite) TearDownTest(c *check.C) {
...
func (suite *DriverOldSuite) TestRootExists(c *check.C) {
...
// storage driver.
func (suite *DriverOldSuite) TestValidPaths(c *check.C) {
...
func (suite *DriverOldSuite) deletePath(c *check.C, path string) {
...
// storage driver.
func (suite *DriverOldSuite) TestInvalidPaths(c *check.C) {
	contents := randomContents(64)
	invalidFiles := []string{
		"",
		"/",
...
func (suite *DriverOldSuite) TestWriteRead1(c *check.C) {
...
func (suite *DriverOldSuite) TestWriteRead2(c *check.C) {
	filename := randomPath(32)
...
func (suite *DriverOldSuite) TestWriteRead3(c *check.C) {
	filename := randomPath(32)
...
func (suite *DriverOldSuite) TestWriteRead4(c *check.C) {
	filename := randomPath(32)
...
// driver safely.
func (suite *DriverOldSuite) TestWriteReadNonUTF8(c *check.C) {
	filename := randomPath(32)
...
func (suite *DriverOldSuite) TestTruncate(c *check.C) {
	filename := randomPath(32)
	contents := randomContents(1024 * 1024)
	suite.writeReadCompare(c, filename, contents)
...
func (suite *DriverOldSuite) TestReadNonexistent(c *check.C) {
	filename := randomPath(32)
	_, err := suite.StorageDriver.GetContent(suite.ctx, filename)
	c.Assert(err, check.NotNil)
...
func (suite *DriverOldSuite) TestWriteReadStreams1(c *check.C) {
	filename := randomPath(32)
	contents := []byte("a")
...
// unicode data.
func (suite *DriverOldSuite) TestWriteReadStreams2(c *check.C) {
	filename := randomPath(32)
	contents := []byte("\xc3\x9f")
	suite.writeReadCompareStreams(c, filename, contents)
}
...
func (suite *DriverOldSuite) TestWriteReadStreams3(c *check.C) {
	filename := randomPath(32)
	contents := randomContents(32)
	suite.writeReadCompareStreams(c, filename, contents)
}
...
// of data.
func (suite *DriverOldSuite) TestWriteReadStreams4(c *check.C) {
	filename := randomPath(32)
	contents := randomContents(1024 * 1024)
	suite.writeReadCompareStreams(c, filename, contents)
}
...
func (suite *DriverOldSuite) TestWriteReadStreamsNonUTF8(c *check.C) {
	filename := randomPath(32)
	contents := []byte{0x80, 0x80, 0x80, 0x80}
	suite.writeReadCompareStreams(c, filename, contents)
}
...
// driver safely.
func (suite *DriverOldSuite) TestWriteReadLargeStreams(c *check.C) {
	if testing.Short() {
...
func (suite *DriverOldSuite) TestReaderWithOffset(c *check.C) {
	filename := randomPath(32)
	defer suite.deletePath(c, firstPart(filename))
...
func (suite *DriverOldSuite) TestContinueStreamAppendLarge(c *check.C) {
...
func (suite *DriverOldSuite) TestContinueStreamAppendSmall(c *check.C) {
	suite.testContinueStreamAppend(c, int64(32))
}

func (suite *DriverOldSuite) testContinueStreamAppend(c *check.C, chunkSize int64) {
	filename := randomPath(32)
	defer suite.deletePath(c, firstPart(filename))
...
// fails.
func (suite *DriverOldSuite) TestReadNonexistentStream(c *check.C) {
	filename := randomPath(32)
...
func (suite *DriverOldSuite) TestList1File(c *check.C) {
	suite.testList(c, 1)
}

// TestList1200Files tests the validity of List calls for 1200 files.
func (suite *DriverOldSuite) TestList1200Files(c *check.C) {
	suite.testList(c, 1200)
}

// testList checks the returned list of keys after populating a directory tree.
func (suite *DriverOldSuite) testList(c *check.C, numFiles int) {
...
func (suite *DriverOldSuite) TestMove(c *check.C) {
	contents := randomContents(32)
...
func (suite *DriverOldSuite) TestMoveOverwrite(c *check.C) {
	sourcePath := randomPath(32)
	destPath := randomPath(32)
...
func (suite *DriverOldSuite) TestMoveNonexistent(c *check.C) {
	contents := randomContents(32)
	sourcePath := randomPath(32)
	destPath := randomPath(32)
...
func (suite *DriverOldSuite) TestMoveInvalid(c *check.C) {
	contents := randomContents(32)
...
// driver
func (suite *DriverOldSuite) TestDelete(c *check.C) {
	filename := randomPath(32)
	contents := randomContents(32)
...
func (suite *DriverOldSuite) TestDeleteDir1File(c *check.C) {
...
func (suite *DriverOldSuite) TestDeleteDir1200Files(c *check.C) {
	suite.testDeleteDir(c, 1200)
}

func (suite *DriverOldSuite) testDeleteDir(c *check.C, numFiles int) {
	rootDirectory := "/" + randomFilenameRange(8, 8)
	defer suite.deletePath(c, rootDirectory)
...
// the created files.
func (suite *DriverOldSuite) buildFiles(c *check.C, parentDir string, num, size int64) []string {
...
func (suite *DriverOldSuite) assertPathNotFound(c *check.C, path ...string) {
	for _, p := range path {
...
func (suite *DriverOldSuite) TestDeleteFiles(c *check.C) {
...
func (suite *DriverOldSuite) TestDeleteFileEqualFolderFileName(c *check.C) {
	parentDir := randomPath(8)
	fileName := "Maryna"
...
func (suite *DriverOldSuite) TestDeleteFilesNotFound(c *check.C) {
	parentDir := randomPath(8)
	defer suite.deletePath(c, firstPart(parentDir))
...
func (suite *DriverOldSuite) benchmarkDeleteFiles(c *check.C, num int64) {
	parentDir := randomPath(8)
	defer suite.deletePath(c, firstPart(parentDir))
...
func (suite *DriverOldSuite) TestDeleteNonexistent(c *check.C) {
	filename := randomPath(32)
	err := suite.StorageDriver.Delete(suite.ctx, filename)
	c.Assert(err, check.NotNil)
	c.Assert(err, check.FitsTypeOf, storagedriver.PathNotFoundError{})
...
func (suite *DriverOldSuite) TestDeleteFolder(c *check.C) {
...
func (suite *DriverOldSuite) TestDeleteOnlyDeletesSubpaths(c *check.C) {
	dirname := randomPath(32)
	filename := randomPath(32)
	contents := randomContents(32)
...
func (suite *DriverOldSuite) TestStatCall(c *check.C) {
...
func (suite *DriverOldSuite) TestPutContentMultipleTimes(c *check.C) {
	filename := randomPath(32)
...
func (suite *DriverOldSuite) TestConcurrentStreamReads(c *check.C) {
...
func (suite *DriverOldSuite) TestConcurrentFileStreams(c *check.C) {
	numStreams := 32
...
func (suite *DriverOldSuite) TestWalkParallel(c *check.C) {
	rootDirectory := "/" + randomFilenameRange(8, 8)
	defer suite.deletePath(c, rootDirectory)
...
func (suite *DriverOldSuite) TestWalkParallelError(c *check.C) {
	rootDirectory := "/" + randomFilenameRange(8, 8)
	defer suite.deletePath(c, rootDirectory)
...
func (suite *DriverOldSuite) TestWalkParallelStopsProcessingOnError(c *check.C) {
...
func (suite *DriverOldSuite) BenchmarkStreamEmptyFiles(c *check.C) {
...
func (suite *DriverOldSuite) BenchmarkStream1KBFiles(c *check.C) {
	suite.benchmarkStreamFiles(c, 1024)
}

// BenchmarkStream1MBFiles benchmarks Writer/Reader for 1MB files
func (suite *DriverOldSuite) BenchmarkStream1MBFiles(c *check.C) {
	suite.benchmarkStreamFiles(c, 1024*1024)
}

// BenchmarkStream1GBFiles benchmarks Writer/Reader for 1GB files
func (suite *DriverOldSuite) BenchmarkStream1GBFiles(c *check.C) {
	suite.benchmarkStreamFiles(c, 1024*1024*1024)
}

func (suite *DriverOldSuite) benchmarkStreamFiles(c *check.C, size int64) {
	c.SetBytes(size)
	parentDir := randomPath(8)
	defer func() {
		c.StopTimer()
...
func (suite *DriverOldSuite) BenchmarkList5Files(c *check.C) {
	suite.benchmarkListFiles(c, 5)
}

// BenchmarkList50Files benchmarks List for 50 small files
func (suite *DriverOldSuite) BenchmarkList50Files(c *check.C) {
	suite.benchmarkListFiles(c, 50)
}

func (suite *DriverOldSuite) benchmarkListFiles(c *check.C, numFiles int64) {
	parentDir := randomPath(8)
	defer func() {
		c.StopTimer()
		suite.StorageDriver.Delete(suite.ctx, firstPart(parentDir))
...
func (suite *DriverOldSuite) BenchmarkDelete5Files(c *check.C) {
	suite.benchmarkDelete(c, 5)
}

// BenchmarkDelete50Files benchmarks Delete for 50 small files
func (suite *DriverOldSuite) BenchmarkDelete50Files(c *check.C) {
	suite.benchmarkDelete(c, 50)
}

func (suite *DriverOldSuite) benchmarkDelete(c *check.C, numFiles int64) {
	for i := 0; i < c.N; i++ {
		parentDir := randomPath(8)
		defer suite.deletePath(c, firstPart(parentDir))
...
func (suite *DriverOldSuite) BenchmarkWalkParallelNop10Files(c *check.C) {
...
func (suite *DriverOldSuite) BenchmarkWalkParallelNop500Files(c *check.C) {
	suite.benchmarkWalkParallel(c, 500, func(fInfo storagedriver.FileInfo) error {
		return nil
	})
}

func (suite *DriverOldSuite) benchmarkWalkParallel(c *check.C, numFiles int, f storagedriver.WalkFn) {
	for i := 0; i < c.N; i++ {
		rootDirectory := "/" + randomFilenameRange(8, 8)
		defer suite.deletePath(c, rootDirectory)
...
func (suite *DriverOldSuite) createRegistry(c *check.C, options ...storage.RegistryOption) distribution.Namespace {
...
func (suite *DriverOldSuite) makeRepository(c *check.C, registry distribution.Namespace, name string) distribution.Repository {
...
func (suite *DriverOldSuite) BenchmarkMarkAndSweep10ImagesKeepUntagged(c *check.C) {
	suite.benchmarkMarkAndSweep(c, 10, false)
}

// BenchmarkMarkAndSweep50ImagesKeepUntagged uploads 50 images, deletes half
// and runs garbage collection on the registry without removing untaged images.
func (suite *DriverOldSuite) BenchmarkMarkAndSweep50ImagesKeepUntagged(c *check.C) {
	suite.benchmarkMarkAndSweep(c, 50, false)
}

func (suite *DriverOldSuite) benchmarkMarkAndSweep(c *check.C, numImages int, removeUntagged bool) {
...
func (suite *DriverOldSuite) buildBlobs(c *check.C, repo distribution.Repository, n int) []digest.Digest {
...
func (suite *DriverOldSuite) TestRemoveBlob(c *check.C) {
	defer suite.deletePath(c, firstPart("docker/"))
...
func (suite *DriverOldSuite) benchmarkRemoveBlob(c *check.C, numBlobs int) {
	defer suite.deletePath(c, firstPart("docker/"))
...
func (suite *DriverOldSuite) BenchmarkRemoveBlob1Blob(c *check.C) {
...
func (suite *DriverOldSuite) BenchmarkRemoveBlob10Blobs(c *check.C) {
...
func (suite *DriverOldSuite) BenchmarkRemoveBlob100Blobs(c *check.C) {
	suite.benchmarkRemoveBlob(c, 100)
}

// TestRemoveBlobs checks that storage.Vacuum is able to delete a set of blobs in bulk.
func (suite *DriverOldSuite) TestRemoveBlobs(c *check.C) {
	defer suite.deletePath(c, firstPart("docker/"))
...
func (suite *DriverOldSuite) benchmarkRemoveBlobs(c *check.C, numBlobs int) {
	defer suite.deletePath(c, firstPart("docker/"))
...
func (suite *DriverOldSuite) BenchmarkRemoveBlobs1Blob(c *check.C) {
...
func (suite *DriverOldSuite) BenchmarkRemoveBlobs10Blobs(c *check.C) {
...
func (suite *DriverOldSuite) BenchmarkRemoveBlobs100Blobs(c *check.C) {
...
func (suite *DriverOldSuite) BenchmarkRemoveBlobs1000Blobs(c *check.C) {
	suite.benchmarkRemoveBlobs(c, 1000)
}

func (suite *DriverOldSuite) buildManifests(c *check.C, repo distribution.Repository, numManifests, numTagsPerManifest int) []storage.ManifestDel {
...
func (suite *DriverOldSuite) TestRemoveManifests(c *check.C) {
	defer suite.deletePath(c, firstPart("docker/"))
...
func (suite *DriverOldSuite) testRemoveManifestsPathBuild(c *check.C, numManifests, numTagsPerManifest int) {
	v := storage.NewVacuum(suite.StorageDriver)
...
func (suite *DriverOldSuite) TestRemoveManifestsPathBuildLargeScale(c *check.C) {
	if testing.Short() {
		c.Skip("Skipping test in short mode")
	}
...
func (suite *DriverOldSuite) benchmarkRemoveManifests(c *check.C, numManifests, numTagsPerManifest int) {
	if testing.Short() {
		c.Skip("Skipping test in short mode")
	}
...
func (suite *DriverOldSuite) BenchmarkRemoveManifests1Manifest0Tags(c *check.C) {
...
// storage.Vacuum.RemoveManifests method.
func (suite *DriverOldSuite) BenchmarkRemoveManifests1Manifest1Tag(c *check.C) {
...
// storage.Vacuum.RemoveManifests method.
func (suite *DriverOldSuite) BenchmarkRemoveManifests10Manifests0TagsEach(c *check.C) {
...
// storage.Vacuum.RemoveManifests method.
func (suite *DriverOldSuite) BenchmarkRemoveManifests10Manifests1TagEach(c *check.C) {
...
// storage.Vacuum.RemoveManifests method.
func (suite *DriverOldSuite) BenchmarkRemoveManifests100Manifests0TagsEach(c *check.C) {
...
// storage.Vacuum.RemoveManifests method.
func (suite *DriverOldSuite) BenchmarkRemoveManifests100Manifests1TagEach(c *check.C) {
...
// storage.Vacuum.RemoveManifests method.
func (suite *DriverOldSuite) BenchmarkRemoveManifests100Manifests20TagsEach(c *check.C) {
	suite.benchmarkRemoveManifests(c, 100, 20)
}

func (suite *DriverOldSuite) testFileStreams(c *check.C, size int64) {
...
func (suite *DriverOldSuite) writeReadCompare(c *check.C, filename string, contents []byte) {
	defer suite.deletePath(c, firstPart(filename))
...
func (suite *DriverOldSuite) writeReadCompareStreams(c *check.C, filename string, contents []byte) {
	defer suite.deletePath(c, firstPart(filename))
