...
// BuildGitlabV1StatisticsURL constructs a URL for the Gitlab v1 API statistics route.
func (ub *Builder) BuildGitlabV1StatisticsURL() (string, error) {
	route := ub.cloneGitLabRoute(v1.Statistics)
